 ...
 * Zooming view.
 */
public class ZoomActivity extends RelativeLayout {

    public ZoomActivity(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ZoomActivity(final Context context) {
        super(context);
    }
